    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600 mb-4">Please sign in to view your notification settings.</p>
              ...
              <div className="flex items-center justify-between">
                <div className="space-y-1">
                  ...
                  <p className="text-sm text-gray-600">
                    Receive our latest updates and news
                  </p>
                </div>
                <Button
                ...
                >
                  {settings.emailNewsletter ? "Enabled" : "Disabled"}
                </Button>
              </div>
          ...
          <CardContent>
            <div className="space-y-6">
              ...
              <div className="flex items-center justify-between">
                ...
                >
                  {settings.emailPromotions ? "Enabled" : "Disabled"}
                </Button>
              </div>
              ...
              <div className="flex items-center justify-between">
                ...
                >
                  {settings.emailSecurity ? "Enabled" : "Disabled"}
                </Button>
              </div>
            </div>
          </CardContent>
